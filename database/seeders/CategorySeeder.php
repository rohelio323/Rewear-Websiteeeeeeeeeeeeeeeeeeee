    ...
    public function run(): void
    {
        $categories = [
            [
                ...
                'co2_constant' => 7.80,
                'reference_note' => 'WRAP (Waste and Resources Action Programme) estimates the carbon footprint of a standard cotton t-shirt at roughly 7.8 kg CO2e, heavily driven by energy-intensive wet pre-treatment and manufacturing.',
            ...
            [
                ...
                'co2_constant' => 15.50,
                'reference_note' => 'Wool production has a high carbon footprint due to livestock methane emissions, while acrylic requires fossil fuels. Extending the life of a sweater saves an average of 15.5 kg CO2e.',
            ...
            [
                ...
                'co2_constant' => 39.00,
                'reference_note' => "Heavy outerwear requires complex synthetic extraction (often petroleum-based) and intensive manufacturing. ThredUp's independent environmental study calculates the footprint of heavy jackets at roughly 39 kg CO2e.",
                'reference_url' => 'https://www.thredup.com/resale/',
            ],
            [
                'category_name' => 'Activewear & Swimwear',
                'co2_constant' => 9.50,
                'reference_note' => 'Activewear relies heavily on virgin polyester and nylon, which are plastics derived from crude oil. Avoiding new production saves roughly 9.5 kg CO2e per garment based on the Higg Materials Sustainability Index.',
                'reference_url' => 'https://higg.com/materials-sustainability-index/',
            ],
            [
                'category_name' => 'Footwear & Shoes',
                'co2_constant' => 14.00,
                'reference_note' => 'A comprehensive MIT lifecycle assessment of standard shoes found that manufacturing and material processing accounts for over 65% of environmental impact, totaling roughly 14 kg CO2e per pair.',
