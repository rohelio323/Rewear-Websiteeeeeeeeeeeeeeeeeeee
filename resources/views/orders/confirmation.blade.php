    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <div class="rounded-2xl bg-emerald-950 p-5 flex flex-col justify-center">
            ...
            <p class="text-2xl font-bold text-white leading-snug mb-2">
                You saved {{ number_format($order->item->category->co2_constant ?? 0, 1) }}kg of<br>CO2 emissions.
            </p>
            ...
            <div class="flex-1">
                ...
                <div class="flex gap-2">
                    ...
                    @elseif($order->item->condition === 'like_new')
                        <span class="text-[10px] font-medium uppercase tracking-widests px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800">Like New</span>
                    @else
